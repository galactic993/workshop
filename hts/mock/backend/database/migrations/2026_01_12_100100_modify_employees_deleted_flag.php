...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // 2. 既存データを移行
        DB::statement("UPDATE employees SET deleted_flag = CASE WHEN deleted_at IS NULL THEN '0' ELSE '1' END");
    ...
    public function down(): void
    {
        ...
        DB::statement("UPDATE employees SET deleted_at = CASE WHEN deleted_flag = '1' THEN NOW() ELSE NULL END");
